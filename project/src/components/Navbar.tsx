...
const Navbar: React.FC<NavbarProps> = ({ currentPage, setCurrentPage }) => {
  ...
  return (
    <>
      <motion.nav 
        className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-sm shadow-sm' : ''}`}
      ...
      >
        <div className="mx-auto px-6 sm:px-8 lg:px-10">
          <div className="flex justify-between items-center h-24">
            ...
            >
              <svg width="150" height="60" viewBox="0 0 512 160" fill="none" className="w-auto h-14">
            ...
            >
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-center border border-gray-300 px-4 py-2.5 rounded-full">
                  ...
                  <span className="text-sm tracking-widest font-light pr-1">MENU</span>
                </div>
              </div>
            </motion.button>
          </div>
        ...
        {isOpen && (
          ...
          >
            <motion.button
              ...
              className="absolute top-6 right-6 text-black p-2 group"
              ...
              {menuItems.map((item, index) => (
                ...
                >
                  <motion.a
                    ...
                    className="text-black text-5xl sm:text-6xl font-light block py-2 cursor-pointer relative z-10"
                    whileHover={{ x: 10 }}
            ...
            <motion.div 
              ...
              className="absolute bottom-8 text-center text-gray-400 px-4 flex flex-col items-center"
            >
              <svg width="120" height="120" viewBox="0 0 512 160" fill="none" className="mb-3 w-auto h-12 opacity-60">
                <path d="M250 10L370 130H130L250 10Z" stroke="currentColor" strokeWidth="3"/>
                <path d="M225 50L275 100H175L225 50Z" stroke="currentColor" strokeWidth="3"/>
                <path d="M175 130L125 40L75 130H175Z" stroke="currentColor" strokeWidth="3"/>
                <path d="M325 130L275 40L225 130H325Z" stroke="currentColor" strokeWidth="3"/>
              ...
              <span className="text-xs">Building Dreams Since 1996</span>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
